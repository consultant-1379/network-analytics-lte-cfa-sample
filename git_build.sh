...
function setRstate {
	...
	mv lte-cfa-sample/build/feature-release.xml lte-cfa-sample/build/feature-release.${rstate}.xml
...
function Arm104nexusDeploy {
        ...
        ArtifactId=$module
        zipName=Ericsson-LTE-Call-Failure-Sample-Analysis

        echo "****"
        echo "Deploying the zip /$zipName-16.0-A.zip as ${ArtifactId}${rstate}.zip to Nexus...."
        mv target/$zipName-16.0-A.zip target/${ArtifactId}.zip
        echo "****"
